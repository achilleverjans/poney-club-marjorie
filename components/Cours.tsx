...
const courses = [
  {
    ...
    desc: 'Une première découverte magique du monde des poneys. Jeux, câlins et promenades en main dans une ambiance ludique et bienveillante.',
  ...
  },
  {
    ...
    title: 'Initiation',
    subtitle: '6 à 12 ans',
    desc: 'Premiers pas en selle dans un cadre sécurisé. Apprentissage des bases de l\'équitation avec bonne humeur.',
